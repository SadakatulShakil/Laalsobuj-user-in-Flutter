              ...
              children: [
                ...
                Builder(
                  builder: (context) => InkWell(
                    onTap: () {
                      if (cart.shippingList != null &&
                          cart.shippingList!.isNotEmpty &&
                          cart.shippingList![0].shippingMethodList != null &&
                          cart.shippingList![0].shippingIndex != null &&
                          cart.shippingList![0].shippingIndex! >= 0 &&
                          cart.shippingList![0].shippingIndex! < cart.shippingList![0].shippingMethodList!.length) {
                        shippingMethodTitle = cart.shippingList![0].shippingMethodList![cart.shippingList![0].shippingIndex!].title.toString();
